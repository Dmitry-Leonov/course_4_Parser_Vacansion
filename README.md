...
В проекте выполняется парсинг по сайтам hh.ru и superjob.ru. Получаем по 100 самых близких к запросу вакансий. Полученные вакансии объединяются в один список и сохраняются в файле vacancies.json
